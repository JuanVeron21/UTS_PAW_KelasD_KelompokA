<?php
    ...
    <html lang="en">
        ...
        <aside >
            <div class="d-flex">
                <div class="side-bar">
                <h2 class="text-light text-center pt-2" style="color: #ffffff; margin-left: 40px;">ATMA LIBRARY</h2>
                <hr>
                <div class="menu">
                    ...
                    <div class="content-menu " >
                        <i class="fa fa-list"></i>
                        <a href="./listUser.php" style="font-weight:600">List Peminjam</a>
                    </div>

                    <div class="content-menu " >
                        <i class="fa fa-list"></i>
                        <a href="./listPinjamanUser.php" style="font-weight:600">Daftar Pinjam</a>
                    </div>
