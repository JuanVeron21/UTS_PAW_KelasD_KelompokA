...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container">
            <a class="navbar-brand fw-bold" href="/UTS_PAW">PHP</a>
        </div>
    </nav>
            ...
            <div class="card-body">
              ...
              <form action="../process/registerProcess.php" method="post">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="nama" required name="nama" aria-describedby="emailHelp" placeholder="Nama">
                </div>

                <div class="mb-3">
                  <label for="exampleInputEmail1" class="form-label">NPM</label>
                  <input class="form-control" id="npm" required name="npm" aria-describedby="emailHelp">
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="email" class="form-control" id="email" required name="email" aria-describedby="emailHelp" placeholder="email@example.com">
                </div>
